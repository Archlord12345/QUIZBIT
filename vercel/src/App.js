...
function App() {
  ...
  const testFirebase = async () => {
    ...
    try {
      ...
      setTestResults(prev => ({
        ...prev,
        firebase: { status: 'error', message: e.message },
      }));
    }
  ...
  const testGemini = async () => {
    ...
    try {
      ...
      setTestResults(prev => ({
        ...prev,
        gemini: { status: 'error', message: e.message },
      }));
    }
  ...
  const testMistral = async () => {
    ...
    try {
      ...
      setTestResults(prev => ({
        ...prev,
        mistral: { status: 'error', message: e.message },
      }));
    }
  ...
  return (
    ...
    >
      ...
      >
        <h1
          style={{ fontSize: '24px', marginBottom: '40px', fontWeight: 'bold' }}
        >
          QuizBit Admin
        </h1>
        <nav>
        ...
        {currentPage === 'dashboard' && (
          <>
            <header style={{ marginBottom: '30px' }}>
              <h2 style={{ fontSize: '28px', color: '#0747A6', margin: 0 }}>
                Global Dashboard
              </h2>
              <p style={{ color: '#6B778C', marginTop: '5px' }}>
                Manage your AI quiz platform and monitor tournaments.
              </p>
            </header>
            <div
              style={{
        ...
        {currentPage === 'questions' && (
          <>
            <header style={{ marginBottom: '30px' }}>
              ...
              <p style={{ color: '#6B778C', marginTop: '5px' }}>
                Recent AI-generated quizzes in Firestore.
              </p>
            </header>
            <div
              style={{
                ...
                <tbody>
                  {quizzes.map(q => (
                    ...
                    >
                      ...
                      <td style={tdStyle}>
                        <button style={btnSmall}>View</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        {currentPage === 'users' && (
          <>
            <header style={{ marginBottom: '30px' }}>
              ...
              <p style={{ color: '#6B778C', marginTop: '5px' }}>
                Global player performance tracking.
              </p>
            </header>
            <div
              style={{
        ...
        {currentPage === 'settings' && (
          <>
            <header style={{ marginBottom: '30px' }}>
              ...
              <p style={{ color: '#6B778C', marginTop: '5px' }}>
                Verify your API connections and system health.
              </p>
            </header>
            <div
              style={{
...
function NavItem({ icon, label, active, onClick }) {
  return (
    ...
    >
      {icon}
      <span style={{ marginLeft: '12px', fontWeight: active ? '600' : '400' }}>
        {label}
      </span>
    </div>
  );
...
function StatCard({ title, value, color }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#172B4D' }}>
        {value}
      </div>
    </div>
  );
