...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#fdf8fa' },
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16 },
  closeButton: { padding: 8, backgroundColor: 'white', borderRadius: 20, borderWidth: 1, borderColor: '#e7e5e4' },
  heartsContainer: { flexDirection: 'row', gap: 4 },
  progressPill: { backgroundColor: '#4d1f4d', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  progressText: { color: 'white', fontSize: 12, fontWeight: 'bold' },
  trackerBarContainer: { width: '100%', height: 6, backgroundColor: '#e7e5e4' },
  trackerBar: { height: '100%', backgroundColor: '#6c2872' },
  ...
  timerText: { fontSize: 16, fontWeight: 'bold', color: '#2e1d33' },
  categoryContainer: { alignItems: 'center', marginBottom: 16 },
  categoryText: { backgroundColor: '#feebd4', color: '#ee6845', fontSize: 10, fontWeight: 'bold', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12, overflow: 'hidden' },
  questionText: { fontSize: 22, fontWeight: 'bold', color: '#2e1d33', textAlign: 'center', marginBottom: 24 },
  optionsList: { gap: 14 },
  ...
  optionSelected: { backgroundColor: '#faeffb', borderColor: '#d8addb' },
  ...
  optionBadge: { width: 32, height: 32, borderRadius: 16, borderWidth: 1, borderColor: '#ebd3eb', backgroundColor: '#f5ecf6', alignItems: 'center', justifyContent: 'center' },
  badgeSelected: { backgroundColor: '#7a317a', borderColor: '#6c2872' },
  badgeCorrect: { backgroundColor: '#10b981', borderColor: '#059669' },
  badgeWrong: { backgroundColor: '#f43f5e', borderColor: '#e11d48' },
  optionBadgeText: { color: '#4d1f4d', fontWeight: 'bold', fontSize: 14 },
  badgeTextSelected: { color: 'white' },
  badgeTextCorrect: { color: 'white' },
  badgeTextWrong: { color: 'white' },
  optionText: { fontSize: 14, fontWeight: 'bold', color: '#2e1d33', flex: 1 },
  openInput: { backgroundColor: 'white', borderWidth: 1, borderColor: '#e7e5e4', borderRadius: 24, padding: 20, fontSize: 16, color: '#2e1d33', fontWeight: 'bold', textAlign: 'center', marginVertical: 10 },
  ...
  explanationTitle: { fontSize: 11, fontWeight: 'bold', color: '#4f46e5', textTransform: 'uppercase', marginBottom: 4 },
  explanationText: { fontSize: 12, color: '#57534e' },
  actionButton: { width: '100%', paddingVertical: 18, borderRadius: 24, backgroundColor: '#4d1f4d', alignItems: 'center' },
